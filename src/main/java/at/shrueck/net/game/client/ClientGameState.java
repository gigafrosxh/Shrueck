...
public record ClientGameState(
    ...
    public static ClientGameState connecting() {
        return new ClientGameState(SessionPhase.CONNECTING, -1, -1, RoundWinner.NONE, 0f, 0, List.of(), null);
    }

    public static ClientGameState disconnected(String reason) {
        return new ClientGameState(SessionPhase.DISCONNECTED, -1, -1, RoundWinner.NONE, 0f, 0, List.of(), reason);
    }
